...
def plot_learning_curve(estimator, title, X, y, axes=None, ylim=None, cv=None,
                        n_jobs=None, train_sizes=np.linspace(.1, 1.0, 5), scoring='f1_micro'):
    """
...
def plot_cm(model, x, y, normalize='true'):
    metrics.plot_confusion_matrix(model, x, y, normalize='true').confusion_matrix
    plt.show()

def print_metrics(clf,x_train, y_train, x_test, y_test):
